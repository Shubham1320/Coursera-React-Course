...
import {Breadcrumb , BreadcrumbItem, Button, Form,Row, FormGroup, Label, Input, Col} from 'reactstrap';
	            	...
	            	<div className="col-12 col-md-9">
	            		<LocalForm onSubmit={(values) => this.handleSubmit(values)}>
	            			...
	            			<Row className="form-group">
	            				...
	            				<Col md={10}>
	            					<Control.text model = ".telnum" className="form-control"  type="tel" id="telnum" name="telnum" placeholder="Tel. Number" />         					    					
	            				</Col>
	            			</Row>
	            			<Row className="form-group">
